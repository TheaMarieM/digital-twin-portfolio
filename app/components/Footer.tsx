        ...
        <div className="grid gap-8 md:grid-cols-3 mb-12">
          <div className="rounded-xl border border-[rgb(var(--border))] bg-[rgb(var(--card))]/50 p-6">
            ...
            <p className="mt-3 text-sm text-[rgb(var(--muted))]">
              IT Student & Web Developer passionate about creating beautiful, functional web experiences.
            </p>
          </div>
          ...
          <div className="rounded-xl border border-[rgb(var(--border))] bg-[rgb(var(--card))]/50 p-6">
            ...
            <div className="flex gap-3">
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-[rgb(var(--border))] bg-[rgb(var(--bg))] hover:bg-[rgb(var(--card))] hover:border-[rgb(var(--accent))] transition-all duration-300 hover:scale-110" 
                aria-label="GitHub"
              >
        ...
        <div className="border-t border-[rgb(var(--border))] pt-8 mt-8">
          <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-6 text-sm">
            <p className="text-[rgb(var(--muted))]">
              © {new Date().getFullYear()} Marithea Magno. All rights reserved.
            </p>
            <div className="flex items-center gap-3 flex-wrap">
              <span className="text-[rgb(var(--muted))]">Built with Next.js, TypeScript & Tailwind CSS</span>
            </div>
          </div>
        </div>
      </div>
